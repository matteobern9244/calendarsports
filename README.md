...
Versione repository corrente: `3.1.1` (il dettaglio di una partita mostra
...
leggendola da `src/lib/version.ts` nel formato `Calendar Events · v3.1.1` (con
`v` minuscola).
...
anche in CI, dentro `bun run verify`.
