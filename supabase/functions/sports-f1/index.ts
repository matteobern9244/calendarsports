...
const F1_DRIVER_PHOTOS: Record<string, string> = {
  ...
  lindblad:
    "https://upload.wikimedia.org/wikipedia/commons/thumb/2/26/Arvid_Lindblad_at_the_Red_Bull_Fan_Zone_%E2%80%93_Crown_Riverwalk%2C_Melbourne_%28028A7832%29.jpg/330px-Arvid_Lindblad_at_the_Red_Bull_Fan_Zone_%E2%80%93_Crown_Riverwalk%2C_Melbourne_%28028A7832%29.jpg",
  perez:
    "https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Sergio_Perez%2C_Red_Bull_Racing_F1_Team%2C_British_GP%2C_Silverstone_2021_%2851348582452%29.jpg/330px-Sergio_Perez%2C_Red_Bull_Racing_F1_Team%2C_British_GP%2C_Silverstone_2021_%2851348582452%29.jpg",
  bottas:
    "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5f/Valtteri_Bottas_at_the_2022_Austrian_Grand_Prix.jpg/330px-Valtteri_Bottas_at_the_2022_Austrian_Grand_Prix.jpg",
};
...
const F1_CONSTRUCTOR_LOGOS: Record<string, string> = {
  ...
  "aston martin":
    "https://media.formula1.com/content/dam/fom-website/teams/2025/aston-martin-logo.png",
  ...
  "rb f1 team":
    "https://media.formula1.com/content/dam/fom-website/teams/2025/racing-bulls-logo.png",
    ...
    switch (action) {
      ...
      default:
        return new Response(
          JSON.stringify({
            error:
              "Azione non valida. Usa: calendar, driver-standings, constructor-standings, last-result, next-race",
          }),
          {
            status: 400,
            headers: { ...corsHeaders, "Content-Type": "application/json" },
