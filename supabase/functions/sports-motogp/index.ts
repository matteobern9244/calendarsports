...
let _seasonsCache: {
  at: number;
  data: Array<{ id: string; year: number; current: boolean }>;
} | null = null;
...
async function fetchMotoGPCategoryId(sampleEventId: string): Promise<string | null> {
  ...
  try {
    const res = await fetch(`${MOTOGP_PULSELIVE_BASE}/categories?eventUuid=${sampleEventId}`, {
      headers: { "User-Agent": "Mozilla/5.0 (compatible; CalendarSports/1.0)" },
    });
...
const MOTOGP_RIDER_PHOTOS_BY_SURNAME: Record<string, string> = {
  bagnaia:
    "https://resources.motogp.pulselive.com/photo-resources/2026/02/05/9772f542-8f9b-4a1c-b7a3-a5fe8f041f75/IfzOWPi2.png?height=200&width=200",
  "marc marquez":
    "https://resources.motogp.pulselive.com/photo-resources/2026/04/01/8027468c-a966-4c58-ad26-17b68bb807b8/gItv2nNj.png?height=200&width=200",
  "alex marquez":
    "https://resources.motogp.pulselive.com/photo-resources/2026/02/05/71b70d16-3d66-4374-abf0-e439f76a13aa/WezEeZAR.png?height=200&width=200",
  martin:
    "https://resources.motogp.pulselive.com/photo-resources/2026/02/21/8a56a9dd-c136-423c-b27b-6763ece0fdc4/y0EBqii2.png?height=200&width=200",
  acosta:
    "https://resources.motogp.pulselive.com/photo-resources/2026/02/21/07d094fd-a8a6-44ae-a1db-67cd43151bfb/fcl8Ojai.png?height=200&width=200",
  bastianini:
    "https://resources.motogp.pulselive.com/photo-resources/2026/02/05/32fd7aeb-d765-45d8-9da3-cc3ca25689cf/7pX3VTcG.png?height=200&width=200",
  bezzecchi:
    "https://resources.motogp.pulselive.com/photo-resources/2026/02/21/4f18dc12-2fef-4ac2-bb31-7e7a220c0aa9/k2TFsiWh.png?height=200&width=200",
  vinales:
    "https://resources.motogp.pulselive.com/photo-resources/2026/02/21/744f450c-6cbe-42e9-9654-da243fe60889/HMYXeFwb.png?height=200&width=200",
  viñales:
    "https://resources.motogp.pulselive.com/photo-resources/2026/02/21/744f450c-6cbe-42e9-9654-da243fe60889/HMYXeFwb.png?height=200&width=200",
  quartararo:
    "https://resources.motogp.pulselive.com/photo-resources/2026/02/05/73805511-aba7-4e37-9361-4e4b35da50fe/L72keLEc.png?height=200&width=200",
  binder:
    "https://resources.motogp.pulselive.com/photo-resources/2026/02/05/9f5512f1-ea75-4c15-a1d7-f4172e8e8eda/PMd3LA13.png?height=200&width=200",
  miller:
    "https://resources.motogp.pulselive.com/photo-resources/2025/02/10/c1787ba0-46dd-4421-acc2-5b752cba4dd8/SNqHTjGK.png?height=200&width=200",
  morbidelli:
    "https://resources.motogp.pulselive.com/photo-resources/2026/02/21/0cf208c4-e1b9-4a8c-ade6-73de98ae1701/motIUIeZ.png?height=200&width=200",
  "di giannantonio":
    "https://resources.motogp.pulselive.com/photo-resources/2026/02/21/d24b3386-4301-4208-ba99-cd9e5c1adc42/GdX3sMJC.png?height=200&width=200",
  fernandez:
    "https://resources.motogp.pulselive.com/photo-resources/2026/02/05/08cfd905-a7b6-438f-949e-f7f480bf3ecd/8Mx8BEXK.png?height=200&width=200",
  zarco:
    "https://resources.motogp.pulselive.com/photo-resources/2026/02/05/49611a81-9931-4191-9820-068b73b54f99/y0R5f9H5.png?height=200&width=200",
  marini:
    "https://resources.motogp.pulselive.com/photo-resources/2026/02/21/73c8564a-a0e0-4dba-9385-a4c0df94d4fc/acF1q0Ma.png?height=200&width=200",
  ...
  ogura:
    "https://resources.motogp.pulselive.com/photo-resources/2026/02/21/b1327ea2-7125-4c56-a3f8-f751f2118ced/nwXR2BjB.png?height=200&width=200",
  razgatlioglu:
    "https://resources.motogp.pulselive.com/photo-resources/2026/02/05/743b343d-2b20-40a7-8ae0-e4f5a273503d/5Zq5W4Wt.png?height=200&width=200",
  aldeguer:
    "https://resources.motogp.pulselive.com/photo-resources/2026/02/21/68e81f3f-b7fc-463b-9df2-d17c2ace42f7/YF1yv3Jm.png?height=200&width=200",
  moreira:
    "https://resources.motogp.pulselive.com/photo-resources/2026/03/04/63a4eefc-ce5c-40cc-9abd-870e7aabaa07/z6IXOQnm.png?height=200&width=200",
  garcia:
    "https://resources.motogp.pulselive.com/photo-resources/2025/11/07/3098c097-ebe6-438c-8615-673b8a8f5ff8/KVM5xr1H.png?height=200&width=200",
  pirro:
    "https://upload.wikimedia.org/wikipedia/commons/7/79/Michele_Pirro_at_the_2025_Malaysian_Grand_Prix.jpg",
  savadori:
    "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Lorenzo_Savadori_2021.jpg/200px-Lorenzo_Savadori_2021.jpg",
  pedrosa:
    "https://upload.wikimedia.org/wikipedia/commons/thumb/2/22/Dani_Pedrosa_2018.jpg/200px-Dani_Pedrosa_2018.jpg",
  crutchlow:
    "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1e/Cal_Crutchlow_2019.jpg/200px-Cal_Crutchlow_2019.jpg",
  bradl:
    "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0e/Stefan_Bradl_2019.jpg/200px-Stefan_Bradl_2019.jpg",
};
...
function expandRiderName(skyName: string): string {
  ...
  const initial =
    parts.length > 1 && parts[parts.length - 1].length <= 2 ? parts[parts.length - 1] : null;
...
function findRiderNumber(name: string): number | null {
  ...
  // Direct surname match
  if (MOTOGP_RIDER_NUMBERS_BY_SURNAME[surname] != null)
    return MOTOGP_RIDER_NUMBERS_BY_SURNAME[surname];
...
function findRiderNationality(name: string): string | null {
  ...
  // Direct surname match
  if (MOTOGP_RIDER_NATIONALITY_BY_SURNAME[surname])
    return MOTOGP_RIDER_NATIONALITY_BY_SURNAME[surname];
...
function getTeamConstructor(teamName: string): string | null {
  ...
  if (t.includes("ducati") || t.includes("vr46") || t.includes("pramac") || t.includes("gresini"))
    return "ducati";
  ...
  try {
    ...
    switch (action) {
      ...
      default:
        return new Response(
          JSON.stringify({
            error: "Azione non valida. Usa: calendar, standings, constructor-standings, next-event",
          }),
          {
            status: 400,
            headers: { ...corsHeaders, "Content-Type": "application/json" },
